...
fn router_help() -> String {
    enum_help(
        ...
        &[
            ...
            ("fetch-models", "Fetch model catalog"),
            ("models", "Alias for /router fetch-models"),
            ("dashboard", "Open dashboard"),
            ("stop", "Stop sidecar"),
            ("restart", "Restart sidecar"),
            ("use-external", "Use external endpoint mode / guided setup"),
...
fn router_suggestions(context: SuggestionContext) -> Option<CommandSuggestionsView> {
    static SUBCOMMANDS: &[(&str, &str)] = &[
        ...
        ("fetch-models", "Fetch OmniRoute model catalog"),
        ("models", "Alias for /router fetch-models"),
